...
\includepdf[fitpaper =true,scale=.6,pagecommand= \subsection{NetzwerkplanIST}\label{app:NetzwerkplanIST}]{Drawing.pdf}
\subsection{Registrierung}
\label{Registrierung}
\includegraphics[scale =0.8]{LANCOMREGISTRIERUNG.png}
